...
* For one of the 450 species known to `birdsize`: the scientific name (as `"Genus species"`) or the AOU code used by the American Ornithological Union (see *LINK*). See *LINK* for a list of the species with data included in `birdsize`.
