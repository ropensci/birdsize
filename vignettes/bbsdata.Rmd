...
# Some of this code taken from MATSS::filter_bbs_species
...
species_raw_masses_match <- species %>%
  ...
  right_join(raw_masses, by = "aou") %>%
  dplyr::filter(!is_unidentified(.data$species.x), !is_unidentified(.data$species.y)) %>% 
