---
title: "Scaling of standard deviation and mean body mass"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Scaling of standard deviation and mean body mass}
...
raw_masses_with_estimated_sd <- raw_masses %>%
  ...
  dplyr::mutate(log_mass = log(.data$mass),
                var = .data$sd ^ 2) %>%
  dplyr::mutate(log_var = log(.data$var),
