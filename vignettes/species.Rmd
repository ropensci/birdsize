...
hummingbird_name_parameters <- species_define(genus = "Selasphorus", species = "calliope")
...
If multiple sets of information are provided (e.g. both `aou` and `genus` and `species`), `species_define` will use it in this order of preference: 
