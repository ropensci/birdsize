...
a_hundred_hummingbirds <- pop_generate(species_abundance = 100, species_code = 244)
...
a_hundred_hypotheticals <- pop_generate(species_abundance = 100, species_mean = 25, species_sd = 3)
...
another_hundred_hypotheticals <- pop_generate(species_abundance = 100, species_mean = 25)
